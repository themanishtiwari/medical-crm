          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <a class="badge badge-primary" data-toggle="modal" data-target="#addData" href="#"><i
                    class="ti-plus"></i>&nbsp;&nbsp;Add Lead</a>
              </div>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                          ...
                          if(!isset($_SESSION['datee1'])){
                          $_SESSION['datee1']="WHERE campion=1";
                        }
                          ...
                          $query=mysqli_query($conn,"SELECT * FROM  patients $daterange");
                                ...
                                //whatsapp message
                                $query5 = mysqli_query($conn,"SELECT * FROM  whatsapp WHERE sr=1");
                                $row5= mysqli_fetch_array($query5);
                                $watsappmessage=$row5['message'];
                        ...
                        <div class=" modal-lg">
                          ...
                          <td class="">
                            <a style="text-decoration: none;" href="https://wa.me/91<?php echo $row['phone']; ?>?text=<?php echo $watsappmessage; ?>" target="_blank" >
          ...
          <form id="contact_form" name="contact_form" method="POST" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input id="form_phone" name="phone" class="form-control" type="number" required>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="form_name">Disease <small>*</small></label>
                  <select id="form_subject" name="disease" class="form-control" type="text" required>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select name="sources" class="form-control" type="text" required>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="form_phone">Other Problem</label>
                  <input id="form_phone" name="other" class="form-control" type="text" value="">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="form_name">Message</label>
                  <input id="form_message" name="message" class="form-control" type="text">
                </div>
              </div>
            ...
            <!-- <div class="form-group">
              <label for="form_name">Remark</label>
              <input id="form_message" name="remark" class="form-control" type="text">
            </div> -->
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group" id="img">
                  <label for="form_name">Upload Report: <i>(only 4 image)</i></label>
                  <input id="img" type="file" name="img[]" multiple><span id="img" class="formerror" style="color: red">
                  </span>
                </div>
              </div>
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <button name="adddata" type="submit" style="float: right;"
                    class="btn btn-success btn-theme-colored btn-flat">Submit</button>
                </div>
              </div>
...
if (isset($_POST["adddata"])) {
      ...
      //cheaking phone number exist or not in database
...
if(count($_FILES['img']['name'])< 5){
	...
	if (in_array($extention, $array)) {
		...
		$img_output[$key]=$store;
		

	list($width,$height)=getimagesize($file);

  include "img-compress.php";
	...
	echo "<h4 style='color: red'>Please select only jpg, png and jpeg image</h4>";
          ...
          $insert="INSERT INTO `patients`(`date`, `time`,`name`, `phone`,`disease`,`message`, `address`, `category`, `sources`, `other`, `report1`,`report2`,`report3`,`report4`) VALUES ('$date','$time','$name','$phone','$disease','$message','$address','$category', '$sources', '$other', '$img_output[0]','$img_output[1]','$img_output[2]','$img_output[3]')";
  ...
  <?php
             ...
             echo "<script>   alert('data addition failed');  </script>";
           }
       }
       else{
        echo "<script>   alert('Please Select 4 images Only');  </script>";
         }              
...
if(count($_FILES['img']['name'])< $number){
  ...
  include "img-compress.php";
	...
	echo "<h4 style='color: red'>Please select only jpg, png and jpeg image</h4>";
            ...
            if($number==5){ 
              $updateimg=mysqli_query($conn,"UPDATE patients SET `report1`='$img_output[0]',`report2`='$img_output[1]',`report3`='$img_output[2]',`report4`='$img_output[3]' WHERE sr=$sr ");
             }
            elseif($number==4){ 
              $updateimg=mysqli_query($conn,"UPDATE patients SET report2='$img_output[0]', report3='$img_output[1]', report4='$img_output[2]' WHERE sr=$sr ");
             }
            elseif($number==3){ 
              $updateimg=mysqli_query($conn,"UPDATE patients SET report3='$img_output[0]', report4='$img_output[1]' WHERE sr=$sr ");
             }
            elseif($number==2){ 
              $updateimg=mysqli_query($conn,"UPDATE patients SET report4='$img_output[0]' WHERE sr=$sr ");
             }
            else{  } 
