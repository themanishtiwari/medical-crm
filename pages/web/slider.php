                  ...
                  error_reporting(0);
                    ...
                    if (isset($_POST["submit"])) {
                      ...
                      if($_FILES['img']['name']){
                        ...
                        $folder= 'static/images/slider/'.$filenameok;
                        $output= '../../static/images/slider/'.$filenameok;
                        ...
                        if (in_array($imgextension, $array)) {
                            if($size<1048576){
                              move_uploaded_file($tempname, $output);                  
                                        ...
                                        $insert="INSERT INTO `slider`(`image`, `title`, `alttag`) VALUES ('$folder','$title','$alttag')";
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php
                          $i=1;
                          include "../../dbcon.php";
                          $table= "SELECT * FROM  slider ORDER BY sr ASC";
                        ...
                        <?php
                                   ...
                                   if (isset($_POST['delete'])) {
                                    $sr=$_POST['delete'];
                                        ...
                                        $update = mysqli_query($conn,"DELETE FROM slider WHERE sr=$sr");
                                  ...
                                  if (isset($_POST["up"])) {
                                    ...
                                    $query="SELECT * FROM slider ORDER BY sr ASC LIMIT 1 OFFSET $num";
                                    $show1 = mysqli_query($conn,$query);
                                    $row1= mysqli_fetch_array($show1);
                                    
                                    $sr1= $row1['sr'];

                                    $data1 = "SELECT * FROM slider where sr=$sr1";
                                    ...
                                    $data2 = "SELECT * FROM slider where sr=$sr2";
                                    ...
                                    $update1=mysqli_query($conn,"UPDATE slider SET `image`='$image2',`title`='$title2',`alttag`='$tag2' WHERE sr=$sr1 ");
                                    $update2=mysqli_query($conn,"UPDATE slider SET `image`='$image1',`title`='$title1',`alttag`='$tag1' WHERE sr=$sr2 ");
